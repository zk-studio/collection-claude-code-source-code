...
def build_scenes():
    ...
    response_lines = [
        ...
        " 553  clawspring.py — REPL entry point, slash commands, rich rendering",
        "────────────────────────────────────────────────────",
        "1261  total",
        "",
        "The largest file is `clawspring.py` containing the interactive REPL,",
    ...
    msg2 = "Write a hello_world.py that prints 'Hello from ClawSpring!'"
    ...
    resp2 = [
        ...
        "",
        "  print('Hello from ClawSpring!')",
        "",
        "Output: Hello from ClawSpring!",
    ]
    tool2 = [
        tool_line("⚙", "Write", "/tmp/hello_world.py", MAUVE),
        tool_ok("Wrote 3 lines to /tmp/hello_world.py"),
...
def render_screenshot(output_path="screenshot.png"):
    ...
    lines = (
        ...
        [
            ...
            text_line(" 553  clawspring.py — REPL + slash commands", 2),
            text_line("────────────────────────────────", 2),
            text_line("1261  total", 2),
            None,
            text_line("The main entry point `clawspring.py` contains the REPL,", 2),
